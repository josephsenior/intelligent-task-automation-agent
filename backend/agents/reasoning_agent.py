...
class ReasoningAgent(BaseAgent):
    ...
    def _create_reasoning_prompt(self, problem: str, context: Dict[str, Any] = None) -> str:
...
Be thorough and show your reasoning process clearly."""
    ...
    def _create_reasoning_result(self, problem: str, reasoning_data: Dict[str, Any]) -> ReasoningResult:

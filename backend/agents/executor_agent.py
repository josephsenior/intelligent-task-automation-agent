...
class ExecutorAgent(BaseAgent):
    ...
    def _infer_tool(self, task_description: str) -> Optional[str]:
        ...
        if any(keyword in description_lower for keyword in ["file", "create file", "read file", "write", "directory"]):
            return "file_operations"
        elif any(keyword in description_lower for keyword in ["git", "commit", "branch", "repository"]):
            return "git_operations"
        elif any(keyword in description_lower for keyword in ["download", "fetch", "request", "http", "url"]):
            return "web_operations"
        elif any(keyword in description_lower for keyword in ["run", "execute", "command", "install", "python", "npm"]):
    ...
    def _get_default_operation(self, tool_name: str, task_description: str) -> Optional[str]:
        """
